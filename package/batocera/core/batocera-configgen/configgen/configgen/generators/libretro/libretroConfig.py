...
def createLibretroConfig(generator: Generator, system: Emulator, controllers: ControllerMapping, metadata: Mapping[str, str], guns: GunMapping, wheels: DeviceInfoMapping, rom: Path, bezel: str | None, shaderBezel: bool, gameResolution: Resolution, gfxBackend: str) -> dict[str, object]:
    ...
    retroarchConfig['sort_savefiles_enable'] = 'true'     # ensure we don't save system.name + core
    retroarchConfig['sort_savestates_enable'] = 'true'    # ensure we don't save system.name + core
    retroarchConfig['savestate_directory'] = SAVES
    retroarchConfig['savefile_directory'] = SAVES
    ...
    retroarchConfig['input_max_users'] = "4"                   # Allow up to 16 players
